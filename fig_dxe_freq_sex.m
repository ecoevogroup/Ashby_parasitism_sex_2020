function fig_dxe_freq_sex

% Generates Fig. 6 - demographic x epidemiological parameters
% (frequency of sex)
...
for i1=1:3
    ...
    for j1=1:4
        ...
        if(exist(filename,'file'))
            ...
            [c,h]=contourf(V2,V1,mean(SEX_MEAN_FULL,3),0:0.1:mx);
            set(gca,'clim',[0,mx])
...
save2pdf('fig_dxe_freq_sex.pdf',gcf,1200)